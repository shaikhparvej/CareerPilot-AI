  ...
  return (
    <footer className={`py-12 ${
      isDarkMode
        ...
        : "bg-gradient-to-br from-slate-50 to-blue-50 text-gray-700 border-t border-slate-200"
    }`}>
            ...
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3
                className={`text-xl font-bold ${
                  isDarkMode ? "text-amber-500" : "text-blue-700"
                }`}
              >
                CareerPilot AI
              </h3>
              ...
              <li className="flex items-center space-x-3">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={isDarkMode ? "text-amber-400" : "text-blue-600"}
                  >
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className={`fixed bottom-8 right-8 w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 z-50 group ${
            isDarkMode
